...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function lo(){return new wr({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:fo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function uo(){return new wr({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:fo(),fragmentShader:`
